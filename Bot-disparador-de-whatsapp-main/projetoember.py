...
navegador = webdriver.Chrome(executable_path=r'C:\Python310\chromedriver.exe')
...
while len(navegador.find_elements_by_id("side")) <1:
    ...
    for i,mensagem in enumerate(contatos_df['Mensagem']):
        ...
        try:
            while len(navegador.find_elements_by_id("side")) < 1:
                time.sleep(8)
            navegador.find_element_by_xpath('//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[1]/div').click()
